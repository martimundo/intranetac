    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box" onclick="window.location.href = '/reservations'" style="cursor:pointer">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Não Conformidade</span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box" onclick="window.location.href = './menus.php'" style="cursor:pointer">
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box" onclick="window.location.href = './users.php'" style="cursor:pointer">
